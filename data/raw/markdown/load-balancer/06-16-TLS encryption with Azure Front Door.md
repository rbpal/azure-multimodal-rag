Transport Layer Security (TLS), previously known as Secure Sockets Layer (SSL), is the standard
...
For Azure Front Door Standard and Premium, you can configure predefined TLS policy or choose the
